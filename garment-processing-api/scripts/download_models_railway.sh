...
# Download using gdown. It is installed through uv project dependencies; keep
# this fallback for direct script execution.
...
python -m gdown "https://drive.google.com/uc?id=${FILE_ID}" -O /tmp/trained_models.zip
