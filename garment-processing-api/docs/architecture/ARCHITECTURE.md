# Garment Processing API - Clean Architecture
...
│   ├── __init__.py
│   ├── classifier.py           # TensorFlow model loading and classification
│   ├── cloudinary_service.py   # Cloud storage
│   ├── gradio_service.py       # Virtual try-on API
│   └── image_processing.py     # Background removal and image composition
...
**Backup:** The original `app.py` has been preserved as `legacy/app_old.py` (710 lines)
