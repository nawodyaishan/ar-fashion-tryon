...
export default function TryOnPage() {
    return (
        <div className="relative min-h-[80vh] flex items-center justify-center py-8 px-2 sm:px-4 md:px-8">
            ...
            <Card
                className="bg-white/60 dark:bg-black/40 border border-white/40 dark:border-black/40 shadow-xl backdrop-blur-md max-w-md w-full mx-auto">
                <CardHeader className="text-center">AR Try-On</CardHeader>
                <CardContent>
                    <p className="text-center">AR try-on functionality coming soon!</p>
                </CardContent>
            </Card>
        </div>
    );
